...
public class ProductList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//sau do ta get 5 product : 
		//truy xuat doanh so cua san pham : 
		//them 1 field data: 
		//thuc chat thi cai file jsp ta pass data qua thi no cung chuyen thanh file java de write html thoi 
		//easy
